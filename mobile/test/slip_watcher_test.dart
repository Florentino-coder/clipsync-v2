import 'package:clipsync_app/slip/slip_content_uri.dart';
...
void main() {
  ...
  test('SlipContentUri exposes clipsync/slip_methods channel', () {
    expect(SlipContentUri.methodChannelName, 'clipsync/slip_methods');
  });
