...
After Render finishes deploying, copy the service URL and use it as a WebSocket URL:
...
```powershell
.\ClipSyncPC.exe --relay-url wss://YOUR-RENDER-SERVICE.onrender.com
```

For Android, set this value in `mobile/lib/clip_service.dart`:

```dart
const kRelayUrl = 'wss://YOUR-RENDER-SERVICE.onrender.com';
```
